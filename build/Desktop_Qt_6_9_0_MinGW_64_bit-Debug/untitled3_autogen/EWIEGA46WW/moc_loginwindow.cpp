...
template <> constexpr inline auto LoginWindow::qt_create_metaobjectdata<qt_meta_tag_ZN11LoginWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onSignUpLinkClicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onForgotPasswordLinkClicked'
...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onSignUpLinkClicked(); break;
        case 3: _t->onForgotPasswordLinkClicked(); break;
        case 4: _t->onSignUpButtonClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginWindow::*)(const QString & )>(_a, &LoginWindow::loginSucceeded, 0))
            return;
    }
}
...
// SIGNAL 0
void LoginWindow::loginSucceeded(const QString & _t1)
{
